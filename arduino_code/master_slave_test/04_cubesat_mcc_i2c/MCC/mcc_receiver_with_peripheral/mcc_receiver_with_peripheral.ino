...
//------------------------------------------------------------------------------
//
// MODULES: LCD 2x16, 433 mHz antennas & peripheral arduino via I2C.
//
//> @author
//> Albert Aarón Cervera Uribe
//
// DESCRIPTION:
//> This script contains a testing version of MCC as controller (master)with a
// second Arduino connected via I2C as peripheral (slave).
//
// Notation:
//
  ...
  switch (key) {
    ...
    case '#':
      if (lastKey == 'B') {
        ...
        // Send command
        sendCommand(4.0, 3);  // Acitvate RTI mode
